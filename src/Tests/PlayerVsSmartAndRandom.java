...
public class PlayerVsSmartAndRandom
{
    ...
    @Test
    public void TestPlayerVsSmartAndRandom()
    {
        ...
        System.out.println("Player end holdings value: " + Config.Currency + players[player].getMoney());
        ...
        System.out.printf("Player percentage change: %.2f%%", ((players[player].getMoney() - initial) / (double)initial) * 100);
        System.out.println();
